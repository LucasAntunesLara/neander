...
public class GenericRegisterFile extends Sequential {

	public GenericRegisterFile ( 	int parNregs, String parName, int parEntries, 
	...
	public void write ( ) {
		...
		for ( i = 0; i < iEntries; i ++) {
			...
			if ( iNwt != -1) cConteudo.set ( lEt, iNwt);
		}
	...
	public static void help ( ) {
		System.out.println ( "GenericRegisterFile: e um banco de registradores");
		...
		System.out.println ( "	Para cria-lo: create <nome> 50 <nregs> <bits> <Nentradas> <Nsaidas>");
		System.out.println ( "		nregs - nro. de registradores no banco");
		System.out.println ( );
	}

	public static void test ( ) {
		GenericRegisterFile rf = new GenericRegisterFile ( 31, "tst", 8, WORD, 2);
	...
	protected Control pcC, pcWriteControl;
