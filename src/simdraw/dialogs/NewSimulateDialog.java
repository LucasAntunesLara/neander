 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class NewSimulateDialog extends JDialog implements Define, ActionListener {

	/**
	 * @throws java.awt.HeadlessException
	 */
	public NewSimulateDialog(Simulator parSim, Processor parProc) throws HeadlessException {
		super();
		sSim = parSim;
		pProc = parProc;
