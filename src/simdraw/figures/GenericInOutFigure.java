 ...
 */
public class GenericInOutFigure extends TDSimFigure implements LinkSimulatorVisualization, Define {
	/**
	 * 
	 */
	public GenericInOutFigure() {
	...
	public GenericInOutFigure(String parName, String parE1, String parS1) {
		initialize();
		fConnectors = null;
		sName = parName;
		sE1 = parE1;
	...
	private void drawStrings (Graphics g) {
		...
		g.drawString(sName, x+(int)(w*0.28), y+(int)(h*0.95));		
		g.setColor(getFrameColor());
	}
...
//		setFont(fb);
	...
	String sName, sE1, sS1, sValueE1, sValueS1;
