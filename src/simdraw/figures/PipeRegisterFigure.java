 ...
 */
public class PipeRegisterFigure extends TDSimFigure implements LinkSimulatorVisualization, Define {
	/**
	 * 
	 */
	public PipeRegisterFigure() {
	...
	public PipeRegisterFigure(	String parName, String parE1, String parS1
								, String parE2, String parS2
								, String parE3, String parS3
								, String parE4, String parS4) {
		initialize();
		fConnectors = null;
		sName = parName;
		//
...
//		super.draw(g);
	...
	private void createConnectors() {
		...
		fConnectors.add(new PortConnector(this, new RelativeLocator(0,0.2),sE1) );
		fConnectors.add(new PortConnector(this, new RelativeLocator(1,0.2),sS1) );
		//
...
//		setFont(fb);
	...
	String sName, sE1, sS1, sE2, sS2, sE3, sS3, sE4, sS4;
	String sValueE1, sValueS1, sValueE2, sValueS2, sValueE3, sValueS3, sValueE4, sValueS4;
