...
public class LogicFigure extends TDSimFigure implements LinkSimulatorVisualization, Define{
	...
	public LogicFigure(String parName, Processor parProc){
	...
	protected void drawLogicFigure(Graphics g) {
		drawFigure ( g);
		drawPorts ( g);
		drawStrings ( g);
	}
