 ...
 */
public class GenericFigure extends TDSimFigure implements LinkSimulatorVisualization, Define {
	/**
	 * 
	 */
	...
	public GenericFigure(String parName, Processor parProc) {
		initialize();
		fConnectors = null;
		sName = parName;
	...
	private void drawStrings (Graphics g) {
		...
		for ( i = 0; i < iControls; i ++) {
			...
			int xDes = x + (int)(w*0.25);
			int wDes = (int) (w*0.5);
			g.drawString(sValueC[i],xDes+(int)(wDes*fDistance*mult),y+h);
		}	
