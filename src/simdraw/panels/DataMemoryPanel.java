 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class DataMemoryPanel extends JPanel implements LinkSimulatorVisualization, Define {

	/**
	 * @throws java.awt.HeadlessException
	 */
	public DataMemoryPanel(Simulator parSim, Processor parProc, String parComp, String parEnd) throws HeadlessException {
		super();
		sSim = parSim;
		pProc = parProc;
		sComp = parComp;
