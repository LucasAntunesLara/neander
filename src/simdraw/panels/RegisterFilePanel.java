 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class RegisterFilePanel extends JPanel implements LinkSimulatorVisualization, Define {

	/**
	 * @throws java.awt.HeadlessException
	 */
	public RegisterFilePanel(Simulator parSim, Processor parProc, String parComp) throws HeadlessException {
		super();
		sSim = parSim;
		pProc = parProc;
		sComp = parComp;
	...
	class MyTableModel extends AbstractTableModel {
		...
		MyTableModel ( ) {
			...
			columnNames [0]= Lang.iLang==ENGLISH?Lang.msgsGUI[94]:Lang.msgsGUI[99];
			columnNames [1]= Lang.iLang==ENGLISH?Lang.msgsGUI[90]:Lang.msgsGUI[95];
		...
		public Object getValueAt(int row, int col) {
			...
			if ( col == 0) {
				String [] archRegs;
				if ( (( archRegs = pProc.getArchitecturalRegistersNames()) != null)) {
					sAux = archRegs [iTmp];
				} else sAux = "r"+LTmp.toString ( );
			}
			else {
