...
main()
{
    ...
    "principles."
      ...
      {
            init_search1( find_strings [i]);
	init_search2( find_strings [i]);
            results [0] = here = strsearch(search_strings[i]);
...
*/
void init_search1 (const char *string)
{
    int i;
...
**  Call this with the string to locate to initialize the table
*/
void init_search2 (const char *string)
{
    int i;
